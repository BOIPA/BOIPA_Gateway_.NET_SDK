...
namespace Turnkey.config
{
    ...
    public class ApplicationConfig
    {
        ...
        public ApplicationConfig(string merchantId,string password,string allowOriginUrl,string merchantNotificationUrl,string merchantLandingPageUrl="",string environment="UAT", string country="IE", string language="en")
        { 
