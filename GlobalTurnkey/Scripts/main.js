...
function invokePurchase() {
    ...
    var data = { "amount": amount, "channel": channel, "country": country, "currency": currency, "paymentSolutionId": paymentSolutionId, "customerId": customerId, "specinCreditCardToken": specinCreditCardToken, "specinCreditCardCVV": specinCreditCardCVV };
...
function invokeVoid() {
    var country = document.getElementById("countryToVoid").value.trim();
    var currency = document.getElementById("currencyToVoid").value.trim();
    var originalMerchantTxId = document.getElementById("originalMerchantTxIdToVoid").value.trim();
    var data = { "country": country, "originalMerchantTxId": originalMerchantTxId, "currency": currency };
    sendRecivePost(data, "api/Void", "Void");
}

function invokeRefund() {
    var amount = document.getElementById("amountToRefound").value.trim();
    var country = document.getElementById("countryToRefound").value.trim();
    var currency = document.getElementById("currencyToRefound").value.trim();
    var originalMerchantTxId = document.getElementById("originalMerchantTxIdToRefound").value.trim();
    var data = { "country": country, "originalMerchantTxId": originalMerchantTxId, "currency": currency, "amount": amount};
...
function invokeRedirect() {
    ...
    var data = { "amount": amount, "channel": channel, "country": country, "currency": currency, "paymentSolutionId": paymentSolutionId, "integrationMode": integrationMode};
...
function pay() {
    ...
    var data = { "amount": amount, "channel": channel, "country": country, "currency": currency, "paymentSolutionId": paymentSolutionId, "customerId": customerId };
    ...
    $.ajax({
        ...
        success: function (rd) {
            ...
            cashier.init({
                baseUrl: "https://cashierui-apiuat.test.myriadpayments.com/ui/cashier"
            });
            cashier.show({
