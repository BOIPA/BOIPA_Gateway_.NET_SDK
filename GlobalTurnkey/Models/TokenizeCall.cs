...
namespace GlobalTurnkey.Models
{
    public class TokenizeCall : ApiCall
    {
        ...
        protected override Dictionary<String, String> getTokenParams(Dictionary<String, String> inputParams)
        {
            ...
            tokenParams.Add("action", ActionType.TOKENIZE.getCode());
        ...
        protected override Dictionary<String, String> getActionParams(Dictionary<String, String> inputParams, String token)
        {
            ...
            actionParams.Add("number", inputParams["number"]);
            actionParams.Add("nameOnCard", inputParams["nameOnCard"]);
            actionParams.Add("expiryMonth", inputParams["expiryMonth"]);
            actionParams.Add("expiryYear", inputParams["expiryYear"]);
